...
import { STATUS_THEME, DEFAULT_THEME } from "../constants/orderConstants.js";
import {
  getOrderActions,
  runOrderAction,
  STATUS_LABELS,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 items-start">
          ...
          <div className="space-y-4 lg:sticky lg:top-20">
            ...
            <SectionCard icon={Scissors} title="Tailor Assignment" accent={theme.accent}>
              ...
              />
              {order.ReturnEmployeeId && (
                <Fact
                  label="Return Handled By"
                  value={
                    order.ReturnEmployeeName
                      ? `${order.ReturnEmployeeName} (#${order.ReturnEmployeeId})`
                      : `#${order.ReturnEmployeeId}`
                  }
                />
              )}
